...
const Marquee = () => {
    return (
        <div>
            <div className='w-full flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)] border-solid border-2 border-red-600'>
