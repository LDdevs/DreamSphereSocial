...
const CardCat = () => {
    return (
        <div className='text-green-300 bg-[rgb(2, 0, 36)])]'>
            ...
            <div className='flex gap-8 flex-wrap justify-center bg-gray-300 h-full py-10 bg-[rgb(2, 0, 36)])]'>
                
                <div
                    className='bg-[rgb(2, 0, 36)])] p-1 m-1 transform  rounded-xl h-40 w-60 sm:h-64 sm:w-64 bg-white shadow-xl transition duration-300 hover:scale-105'>
