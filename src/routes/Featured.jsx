...
const Featured = () => {
    return (
        <div>
            ...
            <CardCat />
            {/* CARDS */}
            <h1 className='md:shrink-0 px-6 mx-[auto] flex text-4xl sm:text-7xl font-bold'>Featured</h1>
            ...
            <h1 className='md:shrink-0 px-6 mx-[auto] flex text-4xl sm:text-7xl font-bold'>Popular</h1>
            <div className="flex grid-col-4 grid-flow-col flex-wrap gap-4">
                <div>
                    <div className="w-80 shadow rounded border border-transparent hover:border-blue-500 cursor-pointer bg-gray-200">
                        <div  id='travelcard' className="h-[auto] w-full rounded-[40px] flex flex-col justify-between p-4 bg-cover bg-center">
            ...
            <h1 className='md:shrink-0 px-6 mx-[auto] flex text-4xl sm:text-7xl font-bold'>New</h1>
            <div className="flex grid-col-4 grid-flow-col flex-wrap gap-4">
                <div>
                    <div className="w-80 shadow rounded border border-transparent hover:border-blue-500 cursor-pointer bg-gray-200">
                        <div  id='travelcard' className="h-[auto] w-full rounded-[40px] flex flex-col justify-between p-4 bg-cover bg-center">
