    ...
    return (
        <div>
            ...
            <div className='grid grid-cols-2 gap-2 w-[auto]'>
                <div className='bg-slate-300  w-[480px]  mx-[20px] p-[20px] text-white '>
                ...
                <div className='bg-slate-300 h-[800px]  w-[screen] flex flex-wrap my-[60px] mr-[200px] px-[240px] py-[400px] text-white'>
