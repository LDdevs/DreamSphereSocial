    ...
    return (
        <div>
            ...
            <div id='dashboardhero' className="mx-[auto] w-full z-1 flex justify-center bg-full items-center text-center px-[80px] py-[7px] bg-cover bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-[rgb(2,0,36);] bg-fixed">
                ...
                <div className='bg-slate-300  w-[1280px] flex flex-wrap mx-[60px] px-[240px] py-[1200] text-white'>
                    <h1>My Bucket List</h1>
                </div>

                <div className='bg-slate-300  w-[1280px] flex flex-wrap mx-[60px] justify-center px-[240px] py-[1200] text-white'>
                    <h1>Friends</h1>
                </div>
                </div>
