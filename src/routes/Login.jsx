...
const Login = () => {
    return (
        <div>
            ...
            <div id='loginhero' className="mx-[auto] w-screen z-1 flex flex-row justify-center items-center text-center px-[80px] py-[70px] bg-cover bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-[rgb(2,0,36);] ">
