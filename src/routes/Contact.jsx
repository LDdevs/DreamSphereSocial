...
const Contact = () => {
    return (
        <div>
            ...
            <div id='hero' className=" h-full w-full z-1 flex justify-center  bg-full items-center text-center px-[80px] py-[7px] bg-cover bg-[url('/assets/boat.png')] text-[rgb(2,0,36);] bg-fixed">
                <div className='h-full '>


                    <div id="hero-header" className="my-[50%]">
                        <img className='min-w-[280px] md:w-[380px] lg:w-[480px] mx-[auto] flex sm:w-auto h-[auto] justify-center align-middle' src={Logo} alt="" />
